...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4170499009ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vism&table=signup">`vism`.`signup`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vism&table=insurance">`vism`.`insurance`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vism&table=customer">`vism`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vism&table=vehicle">`vism`.`vehicle`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="436670305324534173315f265c452340">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="vism" targettable="vehicle">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `vehicle` (`vehicleNo`, `vehicleModel`, `vehicleChassiNo`, `vehicleFuelType`, `vehicleClass`, `vehicleColor`, `customerNIC`) VALUES (&#039;KA4799&#039;, &#039;Nissan&#039;, &#039;HJKF56&#039;, &#039;Petrol&#039;, &#039;Car&#039;, &#039;Blue&#039;, &#039;993570710V&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="vism" targettable="insurance">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `insurance`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="vism" targettable="insurance">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `insurance` (`insuranceID`, `insuranceType`, `insuranceApplyDate`, `insuranceDuration`, `insuranceStatus`, `vehicleNo`, `customerNIC`) VALUES (NULL, &#039;Full Insurance&#039;, &#039;2022-05-22&#039;, &#039;2year&#039;, &#039;pending&#039;, &#039;KA4799&#039;, &#039;993570710V&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
            ...
            Queried time
                            ...
                            <span class="query">CREATE USER &#039;danuka&#039;@&#039;localhost&#039; IDENTIFIED VIA mysql_native_password USING &#039;***&#039;;GRANT ALL PRIVILEGES ON *.* TO &#039;danuka&#039;@&#039;localhost&#039; REQUIRE NONE WITH GRANT OPTION MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="vism" targettable="insurance">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `insurance`  ADD `insuranceExpireDate` DATE NOT NULL  AFTER `customerNIC`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="vism" targettable="insurance">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `insurance`  ADD `insuranceExpireDate` DATE NOT NULL  AFTER `customerNIC`;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="vism" targettable="customer">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE Signup(
userName varchar(20),
customerNIC varchar(20) PRIMARY KEY,
password varchar(20),
role varchar(20)
);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="vism" targettable="signup">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `signup` (`userName`, `customerNIC`, `password`, `role`) VALUES (&#039;danu&#039;, &#039;993570710V&#039;, &#039;danu123&#039;, &#039;customer&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="vism" targettable="signup">
                            <div class="action_content">
